...
void CQueue::init_queue(void) {		//시작을 알리는 함수
...
int CQueue::enqueue(int val) {			//인자 값을 큐에 넣는 함수
...
int CQueue::load_queue(const char* filename) {
...
int CQueue::save_queue(const char* filename)
{
