//문제1-1
//1부터 100까지 수를 1부터 10개씩 10줄로 출력하되, 각 숫자당 3자리로 줄맞춰 출력하세요.
//#include <stdio.h>
//int main()
//{
//	for (int i = 1; i <= 100; i++) {
...
//문제1-2
//1부터 100까지 수를 1부터 10개씩 10줄로 출력하되, 각 숫자당 3자리로 줄맞춰 출력하세요.(배열 사용)
//#include <stdio.h>
//int main()
//{
//	int a[100];
...
//문제1-3
//1부터 100까지 수를 1부터 10개씩 10줄로 출력하되, 각 숫자당 3자리로 줄맞춰 출력하세요.(포인터 사용)
//#include <stdio.h>
//int main()
//{
//	int a[100];
...
//	//10 + sum_to_n(9) → 9 + sum_to_n(8) ... 0 + sum_to_n(-1) → return 0
//}
//int main()
//{
//	printf("합을 구할 최댓값을 입력하세요.\n");
